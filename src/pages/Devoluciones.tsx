    ...
    <div className="bg-[--lumin-bg] font-body text-[--lumin-text] antialiased min-h-screen flex flex-col">
      ...
      <div className="max-w-3xl mx-auto px-5 py-16">
        <header className="mb-14">
          <h1 className="text-4xl font-semibold tracking-tight text-[--lumin-text] mb-3">Devoluciones y Envíos</h1>
          <p className="text-sm text-[--lumin-muted] uppercase tracking-widest font-medium">Última actualización: {lastUpdate}</p>
        </header>

        <main className="space-y-10">
          <section>
            <h2 className="text-lg font-semibold mb-3 text-[--lumin-text] border-b border-[--lumin-border] pb-2">1. Naturaleza del Producto</h2>
            <p className="leading-relaxed text-[--lumin-muted]">
              Lumin es un software como servicio (SaaS), un producto <span className="font-semibold text-[--lumin-text]">100% digital</span>. No es un bien físico, por lo que no existe envío de mercancía ni costos de paquetería.
            </p>
          </section>

          <section>
            <h2 className="text-lg font-semibold mb-3 text-[--lumin-text] border-b border-[--lumin-border] pb-2">2. Entrega del Servicio</h2>
            <p className="leading-relaxed text-[--lumin-muted]">
          ...
          <section>
            <h2 className="text-lg font-semibold mb-3 text-[--lumin-text] border-b border-[--lumin-border] pb-2">3. Garantía de Reembolso de 7 Días</h2>
            ...
            <p className="leading-relaxed text-[--lumin-muted]">
              Para solicitarlo, escríbenos a <span className="font-semibold text-[--lumin-text]">admin@qlatte.com</span> dentro de ese periodo, indicando el correo con el que te registraste. El reembolso se procesa por la misma vía de pago mediante Stripe y puede tardar de 5 a 10 días hábiles en reflejarse, según tu banco.
            </p>
          </section>

          <section>
            <h2 className="text-lg font-semibold mb-3 text-[--lumin-text] border-b border-[--lumin-border] pb-2">4. Cancelación de la Suscripción</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold mb-3 text-[--lumin-text] border-b border-[--lumin-border] pb-2">5. Derecho de Retracto (LFPC)</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold mb-3 text-[--lumin-text] border-b border-[--lumin-border] pb-2">6. Contacto</h2>
            <p className="leading-relaxed text-[--lumin-muted]">
              Para cualquier solicitud de reembolso, cancelación o duda, escríbenos a <span className="font-semibold text-[--lumin-text]">admin@qlatte.com</span> o por WhatsApp al <span className="font-semibold text-[--lumin-text]">+52 722 106 9621</span>.
            </p>
          </section>
        </main>
      </div>
